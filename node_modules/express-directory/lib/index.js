...
StaticFolder.prototype.publicDirectory = function(expressInstance, prefix, folderPath) {
  expressInstance.use(prefix, serveStatic(folderPath));
  return this;
};

StaticFolder.prototype.secureDirectory = function(expressInstance, prefix, folderPath, callback) {
